...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active"><a class="nav-link" href="#">ACCUEIL</a><span
				...
				<li class="dropdown order-1">
					...
					<ul class="dropdown-menu dropdown-menu-right mt-1">
						...
						<li class="p-3" id="formcon">
							...
							<form class="form" role="form" action="./getAllUtilisateurs"
								method="get">
								<div class="form-group text-xs-center">
									<button type="submit" class="btn btn-primary btn-block"
										id="inscription">Inscription</button>
								</div>
							</form>
						</li>
					</ul>
	...
	<div>
		<div>
			...
			<div>
				<h3>Autres</h3>
				<p>Importez, classifiez , prêtez et notez vos autres
					divertissements personnels (Jeux vidéos, collections ...)</p>
			</div>
		</div>
	</div>
	<div>
		...
		<div>
			<div>
				<div>
					...
					<address>concepteur et développeur</address>
				</div>
	...
	<footer>
		<div>
			<div>
				<div>
					<p class="card-footer" id="footerAccueil">Projet_ODL 2018
						v0.0.6-SNAPSHOT</p>
				</div>
			</div>
		</div>
